...
module "k8s-controller-03" {
  ...
  disk_base_volume_id = data.terraform_remote_state.hypervisors.outputs.kvm3_os_images[var.virtual_machines.k8s-controller-03.os]

  network_ip_address     = var.virtual_machines.k8s-controller-03.ip
